...
// A reader that can read customer data from a file
public class Reader {
    ...
    private static List<Customer> parseContent(List<String> fileContent) {
        ...
        for (String line : fileContent) {
            ...
            customers.add(parseAccount(lineComponents));
        }
    ...
    private static Customer parseAccount(List<String> components) {
        ...
        return new Customer(nextId, id, name, balance);
    }
}